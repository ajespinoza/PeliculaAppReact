...
export default function  FormularioPeliculas(props: formularioPeliculaProps){
     ...
     return (
          ...
          {formikProps => (
               <Form>
                    <FormGroupText label="Titulo" campo="titulo"></FormGroupText>
                    <FormGroupCheckbox label="En cines" campo="enCines"></FormGroupCheckbox>
                    ...
                    <FormGroupImagen label="poster" campo="poster" imagenURL={props.modelo.posterURL}></FormGroupImagen>
